...
window.addEventListener("DOMContentLoaded", () => {
  ...
  console.log("test kosio");
  // Sections
  if (document.querySelector(".search_products")) {
    search_products();
  }
  if (document.querySelector(".video_feed_with_text")) {
  ...
  // Partials
  if (document.querySelector(".list_item")) {
    product_lists();
  }
  ...
  //     : auth("_wish") == null
  //     ? get_customer_wishlist_id(auth("_wish"))
  //     : console.log("wish cookie: ", auth("_wish"));
  // } else {
  ...
  if (document.querySelector(".add_to_wishlist") || document.querySelector(".remove_from_wishlist")) {
    add_remove_wishlist();
  }
